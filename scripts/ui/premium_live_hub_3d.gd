...
func _add_game_card(parent: VBoxContainer, game_id: String) -> void:
	...
	panel.add_theme_stylebox_override("panel", Unjam3DTheme.panel_3d(accent.lightened(0.025), 38, accent.lightened(0.42), 4, 18))
	...
	var play := _button("PLAY  ›", Vector2(124, 68), dark, true)
	...
	art_shell.custom_minimum_size = Vector2(370, 312)
	...
	art.custom_minimum_size = Vector2(340, 294)
