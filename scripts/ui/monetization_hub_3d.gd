...
func _build_ui() -> void:
	...
	var watch := FigmaReferenceCanvas.premium_button("▶ +50 COINS",13,Color.WHITE,Color("#ff8c1f"),25,Color("#ffbd64"),1.2)
	...
	var restore := FigmaReferenceCanvas.premium_button("RESTORE PURCHASES",13,Color.WHITE,Color("#086ec7"),16,Color("#70b9ef"),1.2)
	...
	var privacy := FigmaReferenceCanvas.premium_button("PRIVACY OPTIONS",13,Color.WHITE,Color("#086ec7"),16,Color("#70b9ef"),1.2)
	...
	status_label = _add_text(canvas,"",Rect2(23,617,342,52),13,Color("#c6d9ec"))
...
func _add_product_exact(canvas: Control, product_id: String, rect: Rect2, display_title: String, display_subtitle: String) -> void:
	...
	var buy := FigmaReferenceCanvas.premium_button(buy_text,13,Color.WHITE,Color("#ff8c1f"),23,Color("#ffbd64"),1.2)
