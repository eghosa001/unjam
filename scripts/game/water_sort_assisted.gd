...
func build_ui() -> void:
	...
	for child in actions.get_children():
		if child is Button:
			...
			existing.add_theme_font_size_override("font_size", 14)
	var add_tube := RefCanvas.premium_button("+  TUBE • 75◈", 14, Color(1.0, 0.995, 0.97), Color(0.10, 0.66, 1.0), 16, Color(0.55, 0.83, 1.0, 0.56), 1.3)
