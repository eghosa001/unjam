...
func complete_daily(id: String, reward := 100) -> bool:
	var previous := int(SaveManager.data.get("coins", 0))
	var completed := super.complete_daily(id, reward)
