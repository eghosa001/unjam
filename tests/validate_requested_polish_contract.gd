...
func _init() -> void:
	...
	_require("res://scripts/ui/block_piece_button.gd", ["pedestal_rect", "pedestal_gloss", "minf(36.0, fit_cell)", "20.0, 36.0"], errors)
	_require("res://scripts/game/block_puzzle_ultra_motion.gd", ["var height := 124.0", "140.0", "158.0"], errors)
