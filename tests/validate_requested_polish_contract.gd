...
func _init() -> void:
	...
	_require("res://scripts/ui/block_piece_button.gd", ["pedestal_rect", "pedestal_gloss", "minf(32.0, fit_cell)", "18.0, 32.0"], errors)
	_require("res://scripts/game/block_puzzle_ultra_motion.gd", ["var height := 112.0", "136.0", "154.0"], errors)
