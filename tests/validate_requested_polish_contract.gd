...
func _init() -> void:
	...
	_require("res://scripts/ui/premium_main_casual.gd", ["One challenge per game today", "DONE TODAY", "TODAY: %s", "TODAY’S SORT", "SurfaceBackdropHaloTop", "SurfaceGlossSweep"], errors)
	...
	_require("res://scripts/ui/figma_reference_canvas.gd", ["func add_scene_backdrop_layers", "func add_collectible_star", "func add_collectible_gem", "Premium 3D bevel side"], errors)
