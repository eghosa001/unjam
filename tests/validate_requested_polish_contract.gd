...
func _init() -> void:
	...
	_require("res://scripts/ui/premium_main_casual.gd", ["SurfaceKeyLight", "SurfaceAccentGlow", "#d7f8ff", "#72c7dc", "#287fa8"], errors)
	...
	_require("res://scripts/ui/premium_live_hub_3d.gd", ["SelectorWorldDepth", "SelectorFlatGameLogo_", "SelectorKeyLight", "#d7f8ff", "#72c7dc", "#287fa8", "\"CHOOSE A GAME\", Rect2(83, 21, 186, 28), 21", "style_display_title", "mark.configure(game_id)", "SelectorGamePreviewFrame_"], errors)
