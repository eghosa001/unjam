...
func _init() -> void:
	...
	_require("res://scripts/ui/premium_home_direct_levels.gd", ["RESCUE RUSH", "WATER SORT", "BLOCK PUZZLE", "daily_done_count", "HomeHeroFlatGameLogo", "HomeWorldFlatGameLogo", "#4f76b8", "#161b22"], errors)
	...
	_require("res://scripts/ui/premium_live_hub_3d.gd", ["SelectorWorldDepth", "SelectorFlatGameLogo_", "SelectorKeyLight", "#4f76b8", "#3f67aa", "#315596", "\"CHOOSE A GAME\", Rect2(83, 21, 186, 28), 21", "style_display_title", "mark.configure(game_id)", "SelectorGamePreviewFrame_"], errors)
