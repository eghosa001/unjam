...
func _init() -> void:
	...
	_require("res://scripts/ui/premium_live_hub_3d.gd", ["SelectorWorldDepth", "SelectorFlatGameLogo_", "SelectorKeyLight", "#e4dfd5", "#b3aca2", "#80786e", "\"CHOOSE A GAME\", Rect2(83, 26, 186, 34), 23", "style_display_title", "mark.configure(game_id)", "SelectorGamePreviewFrame_"], errors)
