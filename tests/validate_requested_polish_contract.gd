...
func _init() -> void:
	...
	_require("res://scripts/ui/premium_home_direct_levels.gd", ["RESCUE RUSH", "WATER SORT", "BLOCK PUZZLE", "daily_done_count", "HomeHeroFlatGameLogo", "HomeWorldFlatGameLogo", "#eef2f5", "#161b22"], errors)
	...
	_require("res://scripts/ui/premium_main_casual.gd", ["SurfaceKeyLight", "SurfaceAccentGlow", "#eef2f5", "#e6eaee", "#d6dce2"], errors)
	...
	_require("res://scripts/ui/premium_live_hub_3d.gd", ["SelectorWorldDepth", "SelectorFlatGameLogo_", "SelectorKeyLight", "#eef2f5", "#e6eaee", "#d6dce2", "\"CHOOSE A GAME\", Rect2(83, 21, 186, 28), 21", "style_display_title", "mark.configure(game_id)", "SelectorGamePreviewFrame_"], errors)
