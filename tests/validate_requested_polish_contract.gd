...
func _init() -> void:
	...
	_require("res://scripts/ui/premium_home_direct_levels.gd", ["RESCUE RUSH", "WATER SORT", "BLOCK PUZZLE", "daily_done_count", "HomeHeroFlatGameLogo", "HomeWorldFlatGameLogo", "#4f76b8", "#13213a"], errors)
	...
	_require("res://scripts/ui/unjam_3d_theme.gd", ["func strong_font()", "font.variation_embolden = 0.24", "font.variation_embolden = 0.62"], errors)
	...
	_require("res://scripts/ui/premium_main_casual.gd", ["SurfaceKeyLight", "SurfaceAccentGlow", "#4f76b8", "#3f67aa", "#315596"], errors)
	...
	_require("res://scripts/ui/premium_live_hub_3d.gd", ["SelectorWorldDepth", "SelectorFlatGameLogo_", "SelectorKeyLight", "#4f76b8", "#3f67aa", "#315596", "\"CHOOSE A GAME\", Rect2(83, 28, 186, 32), 21", "style_display_title", "mark.configure(game_id)", "SelectorGamePreviewFrame_"], errors)
	...
	_require("res://scripts/game/rescue_rush_polished.gd", ["Physical launch", "One continuous lane tween", "launch_scale", "lane_time"], errors)
