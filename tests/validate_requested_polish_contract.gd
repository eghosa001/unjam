...
func _init() -> void:
	...
	_require("res://scripts/ui/water_tube_3d_motion.gd", ["Premium bottle silhouette built from real geometry", "BottleShoulder3D", "BottleNeck3D", "BottleInnerWall3D"], errors)
