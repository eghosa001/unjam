...
func _init() -> void:
	...
	_require("res://scripts/ui/premium_live_hub_3d.gd", ["SelectorWorldDepth", "SelectorGameArt3D_", "SelectorKeyLight", "#1b63c5", "\"CHOOSE A GAME\", Rect2(83, 21, 186, 28), 21", "style_display_title", "art.configure(game_id, true)", "SelectorGamePreviewFrame_"], errors)
