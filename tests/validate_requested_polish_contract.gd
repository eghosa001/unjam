...
func _init() -> void:
	...
	_require("res://scripts/ui/premium_home_direct_levels.gd", ["RESCUE RUSH", "WATER SORT", "BLOCK PUZZLE", "daily_done_count", "HomeHeroFlatGameLogo", "HomeWorldFlatGameLogo", "#dcebe8", "#29465b"], errors)
	...
	_require("res://scripts/ui/premium_main_casual.gd", ["SurfaceKeyLight", "SurfaceAccentGlow", "#c9f4fb", "#89d4e8", "#4b9fc7"], errors)
	...
	_require("res://scripts/ui/premium_live_hub_3d.gd", ["SelectorWorldDepth", "SelectorFlatGameLogo_", "SelectorKeyLight", "#c9f4fb", "#89d4e8", "#4b9fc7", "\"CHOOSE A GAME\", Rect2(83, 21, 186, 28), 21", "style_display_title", "mark.configure(game_id)", "SelectorGamePreviewFrame_"], errors)
