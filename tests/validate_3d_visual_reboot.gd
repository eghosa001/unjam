...
func _initialize() -> void:
	...
	if not failures.is_empty():
		...
		quit(1)
		return
	print("3D visual reboot contract validated: reference-composed Home, real 3D mascot/rescue character, game previews and gameplay environments with retired flat visual paths removed.")
	quit(0)
