...
func _initialize() -> void:
	...
	_check("res://scenes/BlockPuzzle.tscn", ["block_puzzle_10000.gd", "ui_touch_enhancer_casual.gd"], failures)
	_check("res://scripts/game/block_puzzle_10000.gd", ["extends \"res://scripts/game/block_puzzle_final_polish.gd\"", "CampaignGenerator"], failures)
	_check("res://scripts/game/block_puzzle_final_polish.gd", ["extends \"res://scripts/game/block_puzzle_3d.gd\""], failures)
