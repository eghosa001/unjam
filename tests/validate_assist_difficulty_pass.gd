...
func _initialize() -> void:
	...
	_require_source("res://scripts/ui/premium_home_direct_levels.gd", ["func _continue_selected_game", "start_level", "start_multi_level", "func _open_game_selector", "rescue_rush", "water_sort", "block_puzzle"], "Home active game-level navigation", failures)
