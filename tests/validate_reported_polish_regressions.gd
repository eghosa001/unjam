...
func _init() -> void:
	...
	_require_source("res://scripts/ui/premium_main_casual.gd", ["Rect2(37,y+11,184,18),14", "Rect2(37,y+36,206,16),13", "state_text_color,\n\t\t\t12,\n\t\t\t13"], "Collection upgrade compact text minimums", errors)
