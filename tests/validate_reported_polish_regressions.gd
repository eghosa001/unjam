...
func _init() -> void:
	...
	_require_source("res://scripts/systems/feedback_manager.gd", ["SFX_POOL_SIZE := 8", "not candidate.playing", "_smooth_edge(pulse_phase, 2.0, 0.035)"], "crackle-free audio continuity", errors)
