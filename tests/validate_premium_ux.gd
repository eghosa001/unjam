...
func _initialize() -> void:
	...
	_check_source("res://scripts/game/rescue_rush_casual.gd", ["FigmaRescue390x844", "RescueBoardPanel", "_compact_objective_instruction", "CLEAR A LANE • FREE THE CHICK", "RescueUndoAction", "RescueRestartAction"], failures)
	...
	_check_source("res://scripts/ui/water_tube_reference_button.gd", ["PALETTE", "liquid_base", "glass lip", "Premium bottle silhouette", "size.x * 0.72", "Shoulder bridge", "neck_width := rect.size.x * 0.48", "Crystal overlay", "wall_width", "center_glow", "Local refraction", "visual_pour_rim_local", "visual_receive_rim_local", "play_invalid", "play_success"], failures)
