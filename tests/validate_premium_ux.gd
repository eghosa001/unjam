...
func _initialize() -> void:
	...
	_check_source("res://scripts/game/block_puzzle_ultra_motion.gd", ["GAME_FIRST_BLOCK", "PLACEMENT_HELP", "panel.visible = false", "Vector2(270, 150)", "Control.SIZE_EXPAND_FILL"], failures)
	...
	_check_source("res://scripts/ui/game_first_polish.gd", ["GAME_FIRST_HOME", "GAME_FIRST_SETTINGS", "BoxContainer.ALIGNMENT_CENTER", "grid.columns = 2", "PremiumMiddleFill", "PLAY HISTORY", "Vector2(64, 64)", "EVERY RESCUE COUNTS", "Screen itself remains geometrically fixed"], failures)
	...
	if not failures.is_empty():
		...
		quit(1)
		return
	print("Premium UX contract validated: game-first home/settings, larger Rescue Rush playfield, focused Block Puzzle canvas, readable Water Sort pours, stable navigation, and premium surfaces.")
	quit(0)
