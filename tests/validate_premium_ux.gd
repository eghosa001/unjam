...
func _initialize() -> void:
	...
	_check_source("res://scripts/ui/water_tube_reference_button.gd", ["PALETTE", "liquid_base", "glass lip", "Premium bottle silhouette", "Shoulder bridge", "neck_width := rect.size.x * 0.48", "Local refraction", "play_invalid", "play_success"], failures)
