...
func _initialize() -> void:
	...
	_check_source("res://scripts/game/block_puzzle_ultra_motion.gd", ["GAME_FIRST_BLOCK", "_patch_game_first_layout", "Vector2(270, 150)", "Control.SIZE_EXPAND_FILL"], failures)
